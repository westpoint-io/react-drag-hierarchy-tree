...
export interface IHierarchyTreesContext {
    ...
    editById: (index: number, id: number | string, data: Partial<INestedObject>, action?: 'replace' | 'add' | 'remove', nestedObject?: INestedObject) => INestedObject;
    removeById: (index: number, id: number | string, idsToRemove: Array<number | string>, nestedObject?: INestedObject) => INestedObject;
    findParentByChildId: (index: number, id: number | string, nestedObject?: INestedObject) => {
        parent: INestedObject | null;
        path: Array<number | string>;
    };
    findById: (index: number, id: number | string, nestedObject?: INestedObject) => INestedObject | null;
    isChild: (index: number, parentId: number | string, childId: number | string, nestedObject?: INestedObject) => boolean;
    isDirectChild: (index: number, parentId: number | string, childId: number | string, nestedObject?: INestedObject) => boolean;
    isParent: (index: number, parentId: number | string, childId: number | string, nestedObject?: INestedObject) => boolean;
    addChildrenById: (index: number, id: number | string, data: INestedObject[], nestedObject?: INestedObject) => INestedObject;
...
export interface IHierarchyContextData {
    ...
    findParentByChildId: (id: number | string, nestedObject?: INestedObject) => {
        parent: INestedObject | null;
        path: Array<number | string>;
    };
    findById: (id: number | string, nestedObject?: INestedObject) => INestedObject | null;
    isChild: (parentId: number | string, childId: number | string) => boolean;
    isDirectChild: (parentId: number | string, childId: number | string) => boolean;
...
export declare type IExpandNodes = () => void | undefined;
export declare type IFindById = (id: number | string, nestsObject?: INestedObject | undefined) => INestedObject | null;
export declare type IFindParentByChildId = (id: string | number, nestedObject?: INestedObject | undefined) => {
    parent: INestedObject | null;
    path: (string | number)[];
};
export declare type IRemoveById = (id: number | string, dataToRemove: Array<number | string>, nestedObject?: INestedObject | undefined) => INestedObject;
export declare type IEditById = (id: number | string, data: Partial<INestedObject>, action?: 'replace' | 'add' | 'remove', nestedObject?: INestedObject | undefined) => INestedObject;
export declare type IAddChildrenById = (id: number | string, data: INestedObject[], nestedObject?: INestedObject | undefined) => INestedObject;
export declare type IUpdateTree = (nestedObject: INestedObject) => void;
