...
var ChildrenComponent = /*#__PURE__*/styled.div(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: relative;\n  margin: 0;\n  padding: 0;\n  list-style-type: none;\n  transition: all 1s ease-in-out;\n\n  &:before,\n  &:after {\n    transition: all 0.35s;\n  }\n\n  padding-top: 20px;\n  display: table;\n\n  &:before {\n    content: '';\n    position: absolute;\n    top: 0;\n    left: 50%;\n    width: 0;\n    height: 20px;\n    border-right: ", "\n      solid ", ";\n  }\n\n  &:after {\n    content: '';\n    display: table;\n    clear: both;\n  }\n\n  ", "\n\n  ", "\n"])), function (prop) {
  ...
  return props.reverse && react.css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n      display: flex;\n      padding-top: 0px;\n      padding-bottom: 20px;\n\n      &:before {\n        content: '';\n        position: absolute;\n        top: unset;\n        bottom: 0;\n        left: 50%;\n        width: 0;\n        height: 20px;\n      }\n    "])));
}, function (props) {
  return props.horizontal && react.css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose(["\n      display: table-cell;\n      padding-top: 0;\n      padding-left: 20px;\n\n      &:before {\n        top: calc(50% + 1px);\n        left: 0;\n        width: 20px;\n        height: 0;\n        border-left: 0;\n        border-top: ", " solid\n          ", ";\n      }\n\n      &:after {\n        display: none;\n      }\n\n      & > .org-tree-node {\n        display: block;\n        padding-left: 20px;\n      }\n    "])), props.strokeWidth ? props.strokeWidth : '1px', props.strokeColor ? props.strokeColor : '#000');
});
...
var RenderChildren = function RenderChildren(_ref) {
  ...
  if (Array.isArray(list) && list.length) {
    return React__default.createElement(ChildrenComponent, {
...
var RenderButton = /*#__PURE__*/styled.span(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  display: inline-block;\n  top: 100%;\n  left: 50%;\n  width: 20px;\n  height: 20px;\n  z-index: 10;\n  margin-left: -11px;\n  margin-top: 9px;\n  background-color: ", ";\n  border: 1px solid\n    ", ";\n  border-radius: 50%;\n  box-shadow: 0 0 2px rgba(0, 0, 0, 0.15);\n  cursor: pointer;\n  transition: all 0.35s ease;\n\n  :hover {\n    filter: brightness(0.9);\n    transform: scale(1.1);\n  }\n\n  :before,\n  :after {\n    content: '';\n    position: absolute;\n  }\n\n  :before {\n    top: 50%;\n    left: 4px;\n    right: 4px;\n    height: 0;\n    border-top: 1px solid\n      ", ";\n  }\n\n  :after {\n    top: 4px;\n    left: 50%;\n    bottom: 4px;\n    width: 0;\n    border-left: 1px solid\n      ", ";\n  }\n\n  ", "\n\n  ", "\n"])), function (prop) {
  ...
  return props.expanded && react.css(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteralLoose(["\n      &:after {\n        border: none;\n      }\n    "])));
}, function (props) {
  return props.horizontal && react.css(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteralLoose(["\n      top: 50%;\n      left: 100%;\n      margin-top: -11px;\n      margin-left: 9px;\n    "])));
});
var ContainerButton = /*#__PURE__*/styled.div(_templateObject4 || (_templateObject4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  display: inline-block;\n  top: 100%;\n  left: 50%;\n  width: 20px;\n  height: 20px;\n  z-index: 10;\n  margin-left: -11px;\n  margin-top: 9px;\n  background-color: #fff;\n  border: 1px solid #ccc;\n  border-radius: 50%;\n  box-shadow: 0 0 2px rgba(0, 0, 0, 0.15);\n  cursor: pointer;\n  transition: all 0.35s ease;\n\n  ", "\n"])), function (props) {
  return props.horizontal && react.css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteralLoose(["\n      top: 50%;\n      left: 100%;\n      margin-top: -11px;\n      margin-left: 9px;\n    "])));
});
...
var RenderBtn = function RenderBtn(_ref) {
  ...
  if (renderButton) return React__default.createElement(ContainerButton, {
  ...
  return React__default.createElement(RenderButton, {
...
var CardArea = /*#__PURE__*/styled.div(_templateObject$2 || (_templateObject$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: relative;\n  display: inline-block;\n  cursor: move;\n  z-index: 10;\n  ", "\n"])), function (props) {
  return props.horizontal && react.css(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteralLoose(["\n      display: table-cell;\n      vertical-align: middle;\n    "])));
});
var RenderLabel = /*#__PURE__*/styled.div(_templateObject3$2 || (_templateObject3$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  background-color: white;\n  cursor: grab;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 0 15px;\n  min-width: 100px;\n  min-height: 45px;\n  z-index: 100000;\n  text-align: center;\n  color: black;\n  position: relative;\n  box-shadow: 0 1px 5px rgba(0, 0, 0, 0.15);\n  border-radius: 5px;\n\n  // no break line\n  white-space: nowrap;\n  text-overflow: ellipsis;\n\n  &.mock_card {\n    border: 1px solid #7de874;\n  }\n\n  ", "\n"])), function (props) {
  return props.isDragging && react.css(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteralLoose(["\n      cursor: grabbing;\n    "])));
});
...
var HierarchyContext = /*#__PURE__*/React.createContext({});
function HierarchyTreesContextProvider(_ref) {
  ...
  var treesRef = React.useRef(data);
  React.useEffect(function () {
    treesRef.current = treesData;
  }, [treesData]);
  var updateTree = React.useCallback(function (index, tree) {
  ...
  var addTree = React.useCallback(function (tree) {
    setTreesData(function (current) {
      return [].concat(current, [tree]);
    });
  }, []);
  var getTree = React.useCallback(function (index) {
    return treesRef.current[index];
  }, []);
  var editById = React.useCallback(function (index, id, data, action, nestedObject) {
    if (action === void 0) {
      action = 'add';
    }
  ...
  var addChildrenById = React.useCallback(function (index, id, data, nestedObject) {
    var targetTree = treesRef.current[index];
    var nestedObjectClone = nestedObject ? _extends({}, nestedObject) : _extends({}, targetTree);
    nestedObjectClone = clone(nestedObjectClone);
  ...
  var removeById = React.useCallback(function (index, id, dataToRemove, nestedObject) {
    var targetTree = treesRef.current[index];
    var nestedObjectClone = nestedObject ? _extends({}, nestedObject) : _extends({}, targetTree);
    nestedObjectClone = clone(nestedObjectClone);
  ...
  var findParentByChildId = React.useCallback(function (index, id, nestsObject) {
    var targetTree = treesRef.current[index];
  ...
  var findById = React.useCallback(function ( // nestedObject: INestedObject,
  ...
  var isChild = React.useCallback(function (index, parentId, childId, nestedObject) {
  ...
  var isParent = React.useCallback(function (index, parentId, childId, nestedObject) {
  ...
  var isDirectChild = React.useCallback(function (index, parentId, childId, nestedObject) {
  ...
  var getAllChildrenIds = React.useCallback(function (obj) {
    var childrenIds = [];
  ...
  React.useImperativeHandle(treeDataRef, function () {
    return {
      findById: findById,
  ...
  return React__default.createElement(HierarchyContext.Provider, {
    value: {
      treesData: treesData,
      updateTree: updateTree,
      editById: editById,
...
var RenderCard = function RenderCard(_ref) {
  ...
  return React__default.createElement(CardArea, {
    id: "label_" + data.id,
    key: "label_" + data.id,
    horizontal: !!prop.horizontal,
  ...
  }, renderCard ? React__default.createElement(RenderCustomCard, {
    ...
    canDrop: canDrop,
    treeIndex: index
  }), prop.collapsable && !isLastNode(data, prop) && React__default.createElement(RenderBtn, {
    setExpand: setExpand,
    expand: expand,
    data: data,
    prop: prop
  })) : React__default.createElement(RenderLabel, {
    key: "label_inner_" + data.id,
    ref: drag,
    isDragging: isDragging,
    className: clx.join(' '),
  ...
  }, label), prop.collapsable && !isLastNode(data, prop) && React__default.createElement(RenderBtn, {
    setExpand: setExpand,
    expand: expand,
    data: data,
    prop: prop
...
var OrgTreeNode = /*#__PURE__*/styled.div(_templateObject$3 || (_templateObject$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: relative;\n  margin: 0;\n  padding: 0;\n  list-style-type: none;\n  padding-left: 20px;\n\n  &:before,\n  &:after {\n    transition: all 0.35s;\n  }\n\n  padding-top: 20px;\n  display: table-cell;\n  vertical-align: top;\n\n  &.is-leaf,\n  &.collapsed {\n    padding-left: 10px;\n    padding-right: 10px;\n  }\n\n  &:before,\n  &:after {\n    content: '';\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 50%;\n    height: 19px;\n  }\n\n  &:after {\n    left: 50%;\n    border-left: 1px solid\n      ", ";\n  }\n\n  &:not(:first-of-type):before,\n  &:not(:last-of-type):after {\n    border-top: 1px solid\n      ", ";\n  }\n\n  // remove the line of the first label\n  &.org-tree-node-first {\n    padding-top: 0;\n\n    &:before,\n    &:after {\n      border-left: none;\n      opacity: 0;\n    }\n  }\n\n  ", "\n\n  ", "\n\n  .RdtCant-drop {\n    opacity: 0.5;\n    cursor: no-drop;\n    .org-tree-node-label-inner {\n      background-color: #aaaaaa33;\n    }\n    .org-tree-node-label-inner-personal {\n      opacity: 0.5;\n    }\n  }\n"])), function (prop) {
  ...
  return props.reverse && react.css(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteralLoose(["\n      display: inline-flex;\n      flex-direction: column-reverse;\n      align-items: center;\n      padding-top: 0px;\n      padding-bottom: 20px;\n\n      &:before,\n      &:after {\n        top: unset;\n        bottom: 0;\n      }\n\n      &:not(:first-of-type):before,\n      &:not(:last-of-type):after {\n        border-top: none;\n        border-bottom: 1px solid\n          ", ";\n      }\n    "])), props.strokeColor ? props.strokeColor : '#000');
}, function (props) {
  return props.horizontal && react.css(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteralLoose(["\n      display: table-cell;\n      float: none;\n      padding-top: 0;\n      padding-left: 20px;\n\n      &.is-leaf,\n      &.collapsed {\n        padding-top: 10px;\n        padding-bottom: 10px;\n      }\n\n      &:before,\n      &:after {\n        width: 19px;\n        height: 50%;\n      }\n\n      &:after {\n        top: 50%;\n        left: 0;\n        border-left: 0;\n      }\n\n      &:only-child:before {\n        top: 1px;\n        border-bottom: 1px solid\n          ", ";\n      }\n\n      &:not(:first-of-type):before,\n      &:not(:last-of-type):after {\n        border-top: 0;\n        border-left: 1px solid ", ";\n      }\n\n      &:not(:only-child):after {\n        border-top: 1px solid ", ";\n      }\n\n      // remove the line of the first label\n      &.org-tree-node-first {\n        padding-left: 0;\n\n        &:after {\n          border-left: none;\n          opacity: 0;\n        }\n      }\n    "])), props.strokeColor ? props.strokeColor : '#000', props.strokeColor ? props.strokeColor : '#000', props.strokeColor ? props.strokeColor : '#000');
});
...
var RenderNode = function RenderNode(_ref) {
  ...
  var _useState = React.useState(!(node.expand in data && !data[node.expand])),
      expand = _useState[0],
  ...
  return React__default.createElement(OrgTreeNode, {
  ...
  }, React__default.createElement(RenderCard, {
    hierarchyProps: hierarchyProps,
    setExpand: setExpand,
    expand: expand,
    data: data,
    ...
    mock: mock,
    root: first
  }), (!prop.collapsable || expand) && React__default.createElement(RenderChildren, {
    data: data,
    list: data.children,
    prop: prop,
    mock: mock,
...
var useHierarchy = function useHierarchy(_ref) {
  ...
  var _useState = React.useState(treesData[index]),
      hierarchy = _useState[0],
      setHierarchy = _useState[1];

  var hierarchyRef = React.useRef(hierarchy);
...
var TreeNode = function TreeNode(props) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(RenderNode, {
    data: hierarchy,
    hierarchyProps: hierarchyProps,
    prop: props,
    first: true
  }), React__default.createElement(RenderNode, {
    hierarchyProps: hierarchyProps,
    data: mock_data,
    prop: props,
    mock: true
...
var OrgTreeComponent = function OrgTreeComponent(_ref) {
  ...
  var _useState = React.useState(expandAll),
      expandAllNodes = _useState[0],
      setExpandAllNodes = _useState[1];

  var node = initialState.node;
  var onExpandNodes = React.useCallback(function () {
  ...
  return React__default.createElement(OrgTreeContainer, {
    ...
    horizontal: horizontal
  }, React__default.createElement(TreeNode, Object.assign({
    data: data,
    horizontal: horizontal,
    node: node,
    reverse: reverse,
...
var RenderTrees = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var data = _ref.data,
      _ref$collapsable = _ref.collapsable,
      collapsable = _ref$collapsable === void 0 ? true : _ref$collapsable,
      _ref$expandAll = _ref.expandAll,
  ...
  }, React__default.createElement(HierarchyTreesContextProvider, {
    data: data,
    treeDataRef: ref
  }, data.map(function (tree, i) {
    return React__default.createElement(IndexContextProvider, {
      key: i,
      index: i
    }, React__default.createElement(OrgTreeComponent, Object.assign({
      data: tree,
      collapsable: collapsable,
      expandAll: expandAll,
      horizontal: horizontal,
...
exports.default = RenderTrees;
exports.useTree = useTree;
//# sourceMappingURL=react-drag-hierarchy-tree.cjs.development.js.map
